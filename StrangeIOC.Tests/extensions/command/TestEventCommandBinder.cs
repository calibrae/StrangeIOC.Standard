...
namespace strange.unittests
{
    ...
    public class TestEventCommandBinder
    {
        ...
        private class BadCommand : EventCommand
        {
        ...
        [Test]
        public void TestBadConstructorCleanup()
        {
            ...
            Assert.Throws<CommandException>(delegate { eventDispatcher.Dispatch(TestEvent.TEST); });
        }
    }
}