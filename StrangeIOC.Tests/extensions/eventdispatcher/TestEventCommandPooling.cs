...
namespace strange.unittests
{
    ...
    public class TestEventCommandPooling
    {
        ...
        {
            commandBinder.Bind(SomeEnum.ONE).To<CommandThrowsErrorIfEventIsNull>()
                .To<CommandThrowsErrorIfEventIsNull2>().To<CommandThrowsErrorIfEventIsNull3>().InSequence();
            ...
            var itemsDedicated = EventDispatcher.eventPool.instanceCount - EventDispatcher.eventPool.available;
