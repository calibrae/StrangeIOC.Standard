 ...
 * 
 * Provides the capabilities that allow a ViewedContext to communicate across
 * the ViewedContext boundary. Specifically, CrossContext provides
...
namespace strange.extensions.context.impl
{
    public class CrossContext : Context, ICrossContextCapable
    {
        ...
        public CrossContext( ContextStartupFlags flags) : base( flags)
        {
        }

        public CrossContext( bool autoMapping) : base( autoMapping)
        {
        }
