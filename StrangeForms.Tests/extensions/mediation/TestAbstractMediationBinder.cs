...
//
//
//	class TestMediationBinder : MediationBinder
//	{
//
//		public Dictionary<Element, IMediator> mediators = new Dictionary<Element, IMediator>();
//
//		protected override Element[] GetViews(Element view)
//		{
