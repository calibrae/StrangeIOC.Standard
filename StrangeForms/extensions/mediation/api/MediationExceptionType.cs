...
namespace strange.extensions.mediation.api
{
    ...
    {
        /// Exception raised when a View can't locate a ViewedContext.
        /// Views contact the ViewedContext by "bubbling" their existence up 
        /// the display chain (recursively using transform.parent).
        /// If a View reaches the top of that chain without locating
        /// a ViewedContext, it will raise this Exception to warn you.
        /// 
        ...
        /// ViewModel bound to abstraction that view does not actually extend / implement
        VIEWMODEL_NOT_ASSIGNABLE
    }
}